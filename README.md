[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_progress/raw/main/dist/nv_progress_v5.3.0.pyz)
...
- [novelibre](https://github.com/peter88213/novelibre/) version 5.41+

## Download and install

### Default: Executable Python zip archive

Download the latest release [nv_progress_v5.3.0.pyz](https://github.com/peter88213/nv_progress/raw/main/dist/nv_progress_v5.3.0.pyz)

- Launch *nv_progress_v5.3.0.pyz* by double-clicking (Windows desktop),
- or execute `python nv_progress_v5.3.0.pyz` (Windows), resp. `python3 nv_progress_v5.3.0.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_progress_v5.3.0.zip](https://github.com/peter88213/nv_progress/raw/main/dist/nv_progress_v5.3.0.zip)

- Extract the *nv_progress_v5.3.0* folder from the downloaded zipfile "nv_progress_v5.3.0.zip".
